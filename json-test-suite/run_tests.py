    ...
    "Common Lisp jsown":
        {
            ...
            "commands":[os.path.join(PARSERS_DIR, "test_jsown/test-jsown")]
        },
    "Common Lisp shasht":
        {
            "url":"https://github.com/yitzchak/shasht",
            "commands":[os.path.join(PARSERS_DIR, "test_shasht/test-shasht")]
        },
    "Common Lisp ST-JSON":
        {
            "url":"https://github.com/marijnh/ST-JSON",
            "commands":[os.path.join(PARSERS_DIR, "test_st_json/test-st-json")]
        },
    "Common Lisp YASON":
        {
            "url":"https://github.com/phmarek/yason",
            "commands":[os.path.join(PARSERS_DIR, "test_yason/test-yason")]
        },
    "Common Lisp YASON strict":
        {
            "url":"https://github.com/ralph-schleicher/yason",
            "commands":[os.path.join(PARSERS_DIR, "test_yason_strict/test-yason-strict")]
        }
}
